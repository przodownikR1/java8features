...
public class CountLetterTest {
    ...
    public void guavaCharSetTest() {
        //StrictAssertions.assertThat("ello orld").isEqualTo(CharMatcher.JAVA_UPPER_CASE.removeFrom(TEXT));
        //StrictAssertions.assertThat("ello orld").isEqualTo(CharMatcher.JAVA_LOWER_CASE.or(CharMatcher.breakingWhitespace()).retainFrom(TEXT));

    }

    @Test
    public void guavaCharMatcherTest() {
        //log.info("only digit from sentence : {}", CharMatcher.DIGI.retainFrom("abc12d32"));
    }
}
