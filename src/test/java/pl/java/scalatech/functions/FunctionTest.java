...
public class FunctionTest {
    ...
    public void shouldFunctionWork() {
        StrictAssertions.assertThat(squareAddOne.apply(2l)).isEqualTo(5);
        StrictAssertions.assertThat(addOneSquare.apply(2l)).isEqualTo(9);
        StrictAssertions.assertThat(chainedFunction.apply(2l)).isEqualTo(25);
    }
